/*
 * Date created: 2021-01-13 04:34:25
 */
/*
        ...
        HTML = HTML.replace(/(<script[\s\S]*?>)([\s\S]*?)(<\/script>)/ig, function(_aJavaScripts){return function(match, tagStart, code, tagEnd){
            if(tagStart.indexOf('text/javascript') != -1){
                if(tagStart.indexOf('src=') == -1){
                	...
                	if(typeof reComponentId != 'undefined' && typeof reComponentId.exec != 'undefined') {
...
function aProcClick(idP, idC, idB){
    advClick('//www.amiro.ru/aproc.php?action=click&place='+idP+'&cmpg='+idC+'&id='+idB+'&referer=');
}
...
function rotateBanners(){
    ...
    newBanners.src = '//amiro.ru/aproc.php?action=showall&places='+processShownAdvPlaces(shownAdvPlaces)+'&rs='+advCurTmStamp.getTime()+rndseed.substring(2,11)+'&curl=//amiro.ru/&referer='+encodeURIComponent(document.referrer);
...
function gaqGoURLTrack(url){

  // external link
	if(url.substr(0, 13)=='/go.php?link='){
    gAction = 'goExtLink'; 
    gCategory = ''; 
    gValue = url;
    ...
    switch(url){
      ...
      case 'http://business.amiro.ru/': gAction = 'ViewDemo'; gCategory = 'DemoSite'; gValue = 'pkgBusiness'; break;
      case 'http://minimarket.amiro.ru/': gAction = 'ViewDemo'; gCategory = 'DemoSite'; gValue = 'pkgMinimarket'; break;
      case 'http://vitrina.amiro.ru/': gAction = 'ViewDemo'; gCategory = 'DemoSite'; gValue = 'pkgVitrina'; break;
      case 'http://corporate.amiro.ru/': gAction = 'ViewDemo'; gCategory = 'DemoSite'; gValue = 'pkgCorporate'; break;
      case 'http://visitka.amiro.ru/': gAction = 'ViewDemo'; gCategory = 'DemoSite'; gValue = 'pkgVisitka'; break;
      case 'http://free-cms.amiro.ru/': gAction = 'ViewDemo'; gCategory = 'DemoSite'; gValue = 'pkgFree'; break;

      case 'http://business.amiro.ru/admin.html': gAction = 'ViewDemo'; gCategory = 'DemoPanel'; gValue = 'pkgBusiness'; break;
      case 'http://minimarket.amiro.ru/admin.html': gAction = 'ViewDemo'; gCategory = 'DemoPanel'; gValue = 'pkgMinimarket'; break;
      case 'http://vitrina.amiro.ru/admin.html': gAction = 'ViewDemo'; gCategory = 'DemoPanel'; gValue = 'pkgVitrina'; break;
      case 'http://corporate.amiro.ru/admin.html': gAction = 'ViewDemo'; gCategory = 'DemoPanel'; gValue = 'pkgCorporate'; break;
      case 'http://visitka.amiro.ru/admin.html': gAction = 'ViewDemo'; gCategory = 'DemoPanel'; gValue = 'pkgVisitka'; break;
      case 'http://free-cms.amiro.ru/admin.html': gAction = 'ViewDemo'; gCategory = 'DemoPanel'; gValue = 'pkgFree'; break;
    }
  }
    
	if(url && (url != '')){
            _gaq.push(['_trackEvent', gCategory, gAction, gValue]);
            yaCounter1139378.reachGoal(gAction);
...
function onDownloadClick(id){
	...
	switch(parseInt(id)){
	    ...
	    // track free request
	    case 10001: url = '/how-to/demo/download/free'; gCategory = 'Packages'; gValue = 'pkgRequestFree'; break;

	    case 117: url = '/how-to/demo/download/free/windows/freecms'; gCategory = 'Packages'; gValue = 'pkgWindowsFree'; break;
            case 124: url = '/how-to/demo/download/trials/windows/vizitka'; gCategory = 'Packages'; gValue = 'pkgWindowsVizitka'; break;
            case 116: url = '/how-to/demo/download/trials/windows/corporate'; gCategory = 'Packages'; gValue = 'pkgWindowsCorporate'; break;
            case 125: url = '/how-to/demo/download/trials/windows/vitrina'; gCategory = 'Packages'; gValue = 'pkgWindowsVitrina'; break;
            case 118: url = '/how-to/demo/download/trials/windows/minimarket'; gCategory = 'Packages'; gValue = 'pkgWindowsMinimarket'; break;
            case 115: url = '/how-to/demo/download/trials/windows/business'; gCategory = 'Packages'; gValue = 'pkgWindowsBudiness'; break;

            case 106: url = '/how-to/demo/download/utilities/zend_test'; gCategory = 'Packages'; gValue = 'pkgZendTest'; break;
            case 105: url = '/how-to/demo/download/utilities/php_installer_402'; gCategory = 'Packages'; gValue = 'pkgPHPInstaller402'; break;
            case 158: url = '/how-to/demo/download/utilities/php_installer_506'; gCategory = 'Packages'; gValue = 'pkgPHPInstaller506'; break;
            case 213: url = '/how-to/demo/download/utilities/php_source_code'; gCategory = 'Packages'; gValue = 'pkgPHPSourceCode'; break;

            case 192: url = '/how-to/demo/download/templates/default_templates'; gCategory = 'Packages'; gValue = 'pkgDefaultTemplates'; break;

    	    case 199: url = '/how-to/demo/download/free/unix/installer6'; gCategory = 'Packages'; gValue = 'pkgPHPInstaller6'; break;
    	    case 200: url = '/how-to/demo/download/hosting/unix/aps-installer'; gCategory = 'Packages'; gValue = 'pkgAPSPackage'; break;

    	    case 174: url = '/how-to/demo/download/free/unix/installer'; gCategory = 'Packages'; gValue = 'pkgPHPInstaller'; break;
    	    case 128: url = '/how-to/demo/download/free/unix/freecms'; gCategory = 'Packages'; gValue = 'pkgUnixFree'; break;
            case 130: url = '/how-to/demo/download/trials/unix/vizitka'; gCategory = 'Packages'; gValue = 'pkgUnixVizitka'; break;
            case 127: url = '/how-to/demo/download/trials/unix/corporate'; gCategory = 'Packages'; gValue = 'pkgUnixCorporate'; break;
            case 131: url = '/how-to/demo/download/trials/unix/vitrina'; gCategory = 'Packages'; gValue = 'pkgUnixVitrina'; break;
            case 129: url = '/how-to/demo/download/trials/unix/minimarket'; gCategory = 'Packages'; gValue = 'pkgUnixMinimarket'; break;
            case 126: url = '/how-to/demo/download/trials/unix/business'; gCategory = 'Packages'; gValue = 'pkgUnixBusiness'; break;

            case 191: url = '/how-to/demo/download/movies/view_flv/intro'; gAction = 'ViewFLV'; gCategory = 'Movies'; gValue = 'movFLVIntro'; break;
            case 168: url = '/how-to/demo/download/movies/view_flv/se'; gAction = 'ViewFLV'; gCategory = 'Movies'; gValue = 'movFLVSE'; break;
            case 169: url = '/how-to/demo/download/movies/view_flv/add_page'; gAction = 'ViewFLV'; gCategory = 'Movies'; gValue = 'movFLVAddPage'; break;
            case 171: url = '/how-to/demo/download/movies/view_flv/modules'; gAction = 'ViewFLV'; gCategory = 'Movies'; gValue = 'movFLVModules'; break;
            case 170: url = '/how-to/demo/download/movies/view_flv/add_image'; gAction = 'ViewFLV'; gCategory = 'Movies'; gValue = 'movFLVAddImage'; break;

            case 42: url = '/how-to/demo/download/movies/view/add_news'; gAction = 'View'; gCategory = 'Movies'; gValue = 'movAddNews'; break;
            //case 44: url = '/how-to/demo/download/movies/view/add_page'; gAction = 'View'; gCategory = 'Movies'; gValue = 'movAddPage'; break;
            //case 45: url = '/how-to/demo/download/movies/view/change_logo_name'; gAction = 'View'; gCategory = 'Movies'; gValue = 'movChangeLogoName'; break;
            case 47: url = '/how-to/demo/download/movies/view/add_image_link_file'; gAction = 'View'; gCategory = 'Movies'; gValue = 'movAddImageLinkFile'; break;
            case 49: url = '/how-to/demo/download/movies/view/paste_from_word'; gAction = 'View'; gCategory = 'Movies'; gValue = 'movPasteFromWord'; break;
            case 51: url = '/how-to/demo/download/movies/view/add_visit_counter'; gAction = 'View'; gCategory = 'Movies'; gValue = 'movAddVisitCounter'; break;

            case 164: url = '/how-to/demo/download/movies/flv/se'; gCategory = 'Movies'; gValue = 'movFLVSE'; break;
            case 165: url = '/how-to/demo/download/movies/flv/add_page'; gCategory = 'Movies'; gValue = 'movFLVAddPage'; break;
            case 167: url = '/how-to/demo/download/movies/flv/modules';gCategory = 'Movies'; gValue = 'movFLVModules'; break;
            case 166: url = '/how-to/demo/download/movies/flv/add_image'; gCategory = 'Movies'; gValue = 'movFLVAddImage'; break;

            case 41: url = '/how-to/demo/download/movies/add_news'; gCategory = 'Movies'; gValue = 'movAddNews'; break;
            //case 43: url = '/how-to/demo/download/movies/add_page'; gCategory = 'Movies'; gValue = 'movAddPage'; break;
            //case 46: url = '/how-to/demo/download/movies/change_logo_name'; gCategory = 'Movies'; gValue = 'movChangeLogoName'; break;
            case 48: url = '/how-to/demo/download/movies/add_image_link_file'; gCategory = 'Movies'; gValue = 'movAddImageLinkFile'; break;
            case 50: url = '/how-to/demo/download/movies/paste_from_word'; gCategory = 'Movies'; gValue = 'movPasteFromWord'; break;
            case 52: url = '/how-to/demo/download/movies/add_visit_counter'; gCategory = 'Movies'; gValue = 'movAddVisitCounter'; break;

            case 101: url = '/how-to/demo/download/presents/select_platform'; gAction = 'View'; gCategory = 'Presentations'; gValue = 'pptSelectPlatform'; break;
            case 99: url = '/how-to/demo/download/presents/strategy'; gAction = 'View'; gCategory = 'Presentations'; gValue = 'pptStrategy'; break;
            case 98: url = '/how-to/demo/download/presents/web_developers_selection'; gAction = 'View'; gCategory = 'Presentations'; gValue = 'pptWebDevelopersSelection'; break;
            case 100: url = '/how-to/demo/download/presents/six_groups'; gAction = 'View'; gCategory = 'Presentations'; gValue = 'pptSixGroups'; break;
            case 209: url = '/how-to/demo/download/presents/seo-buklet';  gCategory = 'Presentations'; gValue = 'fileSeoBuklet'; break;
            case 210: url = '/how-to/demo/download/presents/eshop-buklet';  gCategory = 'Presentations'; gValue = 'fileEshopBuklet'; break;

            case 139: url = '/how-to/demo/download/press_kit/trademark'; gCategory = 'PressKit'; gValue = 'fileTrademark'; break;
            case 140: url = '/how-to/demo/download/press_kit/about_full'; gCategory = 'PressKit'; gValue = 'fileAboutFull'; break;
            case 141: url = '/how-to/demo/download/press_kit/about_brief'; gCategory = 'PressKit'; gValue = 'fileAboutBrief'; break;
            case 145: url = '/how-to/demo/download/press_kit/amiro_presentation'; gCategory = 'PressKit'; gValue = 'fileAmiroPresentation'; break;
            case 153: url = '/how-to/demo/download/press_kit/screenshots'; gCategory = 'PressKit'; gValue = 'fileScreenshots'; break;
            case 154: url = '/how-to/demo/download/press_kit/buklet_builder'; gCategory = 'PressKit'; gValue = 'fileBukletBuilder'; break;
            case 155: url = '/how-to/demo/download/press_kit/buklet_success'; gCategory = 'PressKit'; gValue = 'fileBukletSuccess'; break;
            case 156: url = '/how-to/demo/download/press_kit/buklet_partnersheep'; gCategory = 'PressKit'; gValue = 'fileBukletPartnership'; break;

	    default: url = '/unknown/'; gAction = 'Unknown'; gCategory='Unknown'; gValue = 'Unknown'; break;
	}
	  if(url != ''){
            _gaq.push(['_trackEvent', gCategory, gAction, gValue]);
            if(typeof yaCounter1139378 !== 'undefined') {
                yaCounter1139378.reachGoal(gCategory);
            }
	  }
    }
}
...
function okno2()
{
document.getElementById('QuickRequestFull').style.display  = 'none';
//document.getElementById('QuickRequest').style.marginLeft = '197px';
}
...
if (display  == 'none'){
	document.getElementById('QuickRequestFull').style.display  = 'block';
	document.getElementById('QuickRequestFull').style.width  = '230px';
}
else {
	document.getElementById('QuickRequestFull').style.display  = 'none';
	document.getElementById('QuickRequestFull').style.width  = '33px';
}
...
function showhide(id) {
    document.getElementById(id).style.display  = (document.getElementById(id).style.display != 'none') ? "none" : "table-cell";
}
...
function initQuickForm(){
    if(AMI.Browser.isIE){
  	...
  	//w_window = Math.round((w_window - 1000)/4);
    if (0 && w_window > 1280){
        w_window = (w_window - 1000)/4;  
        if (w_window < 0 ) w_window = 0;
        document.getElementById('QuickRequestForm').style.left = w_window + 'px';
        document.getElementById('QuickRequestForm').style.visibility = 'visible'; 
        //setTimeout("DocumentLoad()", 100);
    }else{
        document.getElementById('QuickRequestForm').style.left = 0 + 'px';
        document.getElementById('QuickRequestForm').style.visibility = 'visible'; 
        //setTimeout("DocumentLoad()", 100);
    }
}
...
function getUrlParam(name){
  ...
  var aResults = regexp.exec(window.location.href);
  if(aResults==null ){
    return '';
  }else{
    return decodeURIComponent(aResults[1]);
  }
}

function initYandexMaps() {
    if(document.getElementById("YMapsIDMSK")){
        var map = new YMaps.Map(document.getElementById("YMapsIDMSK"));
        map.setCenter(new YMaps.GeoPoint(37.77308,55.807577), 14, YMaps.MapType.MAP);
        ...
        s.iconStyle.href = "//api-maps.yandex.ru/i/0.3/placemarks/pmlbm.png";
        s.iconStyle.size = new YMaps.Point(28,29);
        //YMaps.Styles.add("wizard#lbmPoint", s);
        
        var placemark1 = new YMaps.Placemark(new YMaps.GeoPoint(37.772738,55.808498), {style: "wizard#lbmPoint", balloonOptions: {maxWidth: 300}});
        placemark1.setIconContent("Компания Амиро");
        placemark1.setBalloonContent("Компания Амиро");
        map.addOverlay(placemark1);
    }
    if(document.getElementById("YMapsIDMSK")){
        var map = new YMaps.Map(document.getElementById("YMapsIDNSK"));
        map.setCenter(new YMaps.GeoPoint(82.914001,55.056933), 15, YMaps.MapType.MAP);
        map.addControl(new YMaps.Zoom());
        map.addControl(new YMaps.ToolBar());
        map.addControl(new YMaps.TypeControl());        
        var s = new YMaps.Style();
        ...
        var placemark1 = new YMaps.Placemark(new YMaps.GeoPoint(82.914001,55.056933), {style: "wizard#lbmPoint", balloonOptions: {maxWidth: 300, mapAutoPan: 1, margin: [40, 40, 40, 40]}});
        placemark1.setIconContent("<IMG style='WIDTH: 14px; HEIGHT: 14px' border=0 hspace=2 align=absMiddle src='_mod_files/ce_images/officemap-ico.png' width=14 height=14>Компания Амиро");
        //placemark1.setIconContent("<IMG onclick='show_picture(this.getAttribute(\'data-ami-mbpopup\'))' data-ami-mbpopup='_mod_files/ce_images/europa01.jpg' style='WIDTH: 120px; HEIGHT: 120px' border=0 hspace=0 src='_mod_files/ce_images/amiro-new-office.gif' width=120 height=120>Компания Амиро");
        placemark1.setBalloonContent("Компания Амиро<br><IMG onclick='AMI.UI.MediaBox.open(\"_mod_files/ce_images/europa01.jpg\")' data-ami-mbpopup='_mod_files/ce_images/europa01.jpg' style='WIDTH: 120px; HEIGHT: 120px' border=0 hspace=0 src='_mod_files/ce_images/amiro-new-office.gif' width=120 height=120>");
	//var baloon1 = placemark1.getBaloon();
        map.addOverlay(placemark1);
    }
}
...
function showLoginForm(){
    oLoginForm = document.getElementById('quick_login_block');
    fadeIn(oLoginForm, 300);
}

function hideLoginForm(){
    oLoginForm = document.getElementById('quick_login_block');
    fadeOut(oLoginForm, 300);
}

function switchLoginForm(){
    if (document.getElementById('quick_login_block').style.visibility != 'visible'){
        showLoginForm();
    }else{
        hideLoginForm();
    }
...
var affInterfaceOptions = '&pr_code=65eH2F5170rGJGR7g635xz7LWOmb0y&shop=z1-gray-green&locale=ru';

function IncludeAffInterface(options,file){
	if(!file) file = 'pr_interface';
	options = affInterfaceOptions + (options ? '&'+options : '');
	document.write('<script type="text/javascript" src="//www.templatehelp.com/codes/'+file+'.php?'+options+'"><'+'/script>');
}
...
addOnLoadEvent(initYandexMaps);
//addOnLoadEvent(initQuickForm);
savePreviousOnLoadEvent();
...
function positioningMenu(smNum, relateToParentX, relateToParentY, deltaX, deltaY, directionX, directionY){
    ...
    menuObj.style.left = parentPosition[0] + parentWidth + 'px';
    menuObj.style.top = parentPosition[1] + parentHeight + 'px';
...
*/
    menuObj.style.left = parentPosition[0] + leftPosition + 'px';
    menuObj.style.top = parentPosition[1] + topPosition + 'px';
